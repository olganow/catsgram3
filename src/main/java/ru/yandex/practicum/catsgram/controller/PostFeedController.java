...
//класс ObjectMapper, который умеет сериализовать и десериализовать JSON. Spring Boot настраивает объект ObjectMapper и
// преобразует его в бин. Разработчику не приходится ничего делать самостоятельн
